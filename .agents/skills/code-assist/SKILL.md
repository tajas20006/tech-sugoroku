...
- **documentation_dir** (optional, default: ".scratchpad/{project_name}"): The directory where planning documents will be stored
...
3. Set up directory structure in .scratchpad/{project_name}/email-validator/
